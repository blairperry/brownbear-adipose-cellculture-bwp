...
### Making boxplots of specific genes

```{r}
idmap <- read.csv("IDmap_2019_02_20.csv", header = T)
gene_all<- as.matrix(y$counts, header =T, row.names = 1)
...
gene_boxplot_liver = function(d, n, i){
  ...
  group = factor(c("AA", "AH", "AP", "HA", "HH", "HP","AA", "AH", "AP", "HA", "HH", "HP","AA", "AH", "AP", "HA", "HH", "HP","AA", "AH", "AP", "HA", "HH", "HP","AA", "AH", "AP", "HA", "HH", "HP","AA", "AP", "HA", "HH", "HP"))
...
```{r}
cpm_genes = as.data.frame(cpm(gene_all))
group = factor(c("AA", "AH", "AG", "HA", "HH", "HG","AA", "AH", "AG", "HA", "HH", "HG","AA", "AH", "AG", "HA", "HH", "HG","AA", "AH", "AG", "HA", "HH", "HG","AA", "AH", "AG", "HA", "HH", "HG","AA", "AG", "HA", "HH", "HG"))
d = "gene5326"
goi = cpm_genes[d,]
#top.title = idmap[idmap$Gene_name == d,]$Annotation
colnames(goi) = group
topgene = t(goi)
txgene = melt(as.matrix(topgene))
p7 <- ggplot(txgene, aes(x=Var1, y=value, fill=group)) +
  geom_boxplot(show.legend = FALSE, fill = "white") +
  scale_fill_viridis(discrete = TRUE) +
  ggtitle("DEPTOR") +
  geom_jitter(show.legend = FALSE, size = 5, width = 0.05) +
...
topgene = t(goi)
txgene = melt(as.matrix(topgene))
p8 <- ggplot(txgene, aes(x=Var1, y=value, fill=group)) +
  geom_boxplot(show.legend = FALSE, fill = "white") +
  scale_fill_viridis(discrete = TRUE) +
  ggtitle("TBC1D1") +
  geom_jitter(show.legend = FALSE, size = 5, width = 0.05) +
...
topgene = t(goi)
txgene = melt(as.matrix(topgene))
p9 <- ggplot(txgene, aes(x=Var1, y=value, fill=group)) +
  geom_boxplot(show.legend = FALSE, fill = "white") +
  scale_fill_viridis(discrete = TRUE) +
  ggtitle("RICTOR") +
  geom_jitter(show.legend = FALSE, size = 5, width = 0.05) +
...
topgene = t(goi)
txgene = melt(as.matrix(topgene))
p10 <- ggplot(txgene, aes(x=Var1, y=value, fill=group)) +
  geom_boxplot(show.legend = FALSE, fill = "white") +
  scale_fill_viridis(discrete = TRUE) +
  ggtitle("MEST") +
  geom_jitter(show.legend = FALSE, size = 5, width = 0.05) +
...
topgene = t(goi)
txgene = melt(as.matrix(topgene))
p11 <- ggplot(txgene, aes(x=Var1, y=value, fill=group)) +
  geom_boxplot(show.legend = FALSE, fill = "white") +
  scale_fill_viridis(discrete = TRUE) +
  ggtitle("EGFL6") +
  geom_jitter(show.legend = FALSE, size = 5, width = 0.05) +
...
topgene = t(goi)
txgene = melt(as.matrix(topgene))
p12 <- ggplot(txgene, aes(x=Var1, y=value, fill=group)) +
  geom_boxplot(show.legend = FALSE, fill = "white") +
  scale_fill_viridis(discrete = TRUE) +
  ggtitle("NCS1") +
  geom_jitter(show.legend = FALSE, size = 5, width = 0.05) +
...
```{r}
Bool_up <- read.csv("Boolean_Upregulated.csv", header = T)
Bool_down <- read.csv("Boolean_Downregulated.csv", header = T)

pdf('Figures/Upregulated_upset.pdf')
upset(Bool_up, nsets=15, nintersects=NA, sets = c("HA.vs..HH", "AA.vs..HH", "HG.vs..HH", "AH.vs..HH", "AG.vs..HH", "AA.vs..AH", "AA.vs..HA", "AG.vs..HG", "AA.vs..AG", "AA.vs..HG", "HA.vs..HG"), keep.order = TRUE,
        intersection = list("HA.vs..HH", "AA.vs..HH", "HG.vs..HH", "AH.vs..HH", "AG.vs..HH", "AA.vs..AH", "AA.vs..HA", "AG.vs..HG", "AA.vs..AG", "AA.vs..HG", "HA.vs..HG", list("AA.vs..HH", "AH.vs..HH"), list("AA.vs..HH", "HG.vs..HH"), list("AA.vs..AG", "AA.vs..HG"), list("AG.vs..HH", "HG.vs..HH"), list("AH.vs..HH", "HG.vs..HH", "AA.vs..HH", "HA.vs..HH", "AG.vs..HH"), list("HA.vs..HH", "AA.vs..AH")),
        order.by = "degree", sets.x.label="Total DE gene count", mainbar.y.label="Overlapping DE gene count", text.scale=c(1.6, 1.5, 1.4, 1.2, 1.3, 1), number.angles=0)
dev.off()

pdf("Figures/Downregulated_upset.pdf")
upset(Bool_down, nsets=15, nintersects=NA, sets = c("HA.vs..HH", "AA.vs..HH", "HG.vs..HH", "AH.vs..HH", "AG.vs..HH", "AA.vs..AH", "AA.vs..HA", "AG.vs..HG", "AA.vs..AG", "AA.vs..HG", "HA.vs..HG"), keep.order = TRUE,
      intersection = list("HA.vs..HH", "AA.vs..HH", "HG.vs..HH", "AH.vs..HH", "AG.vs..HH", "AA.vs..AH", "AA.vs..HA", "AG.vs..HG", "AA.vs..AG", "AA.vs..HG", "HA.vs..HG", list("AA.vs..HH", "AH.vs..HH"), list("AA.vs..HH", "HG.vs..HH"), list("AA.vs..AG", "AA.vs..HG"), list("AG.vs..HH", "HG.vs..HH"), list("AH.vs..HH", "HG.vs..HH", "AA.vs..HH", "HA.vs..HH", "AG.vs..HH"), list("HA.vs..HH", "AA.vs..AH")),
      order.by = "degree", sets.x.label="Total DE gene count", mainbar.y.label="Overlapping DE gene count", text.scale=c(1.6, 1.5, 1.4, 1.2, 1.3, 1), number.angles=0)
dev.off()

#pdf("Figures/UpsetHS.pdf", height=7, width=7)
#upset(Bool, nsets=10, nintersects=25, sets.x.label="Total hotspot count", mainbar.y.label="Overlapping hotspot count", text.scale=c(1.6, 1.5, 1.4, 1.2, 1.3, 1))
#dev.off()

intersection = list("HA.vs..HH", "AA.vs..HH", "HPD.vs..HH", "AH.vs..HH", "AA.vs..AH", "AA.vs..HA", "APD.vs..HPD", "AA.vs..APD", "HA.vs..HPD", list("AA.vs..HH", "AH.vs..HH"), list("AH.vs..HH", "HPD.vs..HH", "AA.vs..HH", "HA.vs..HH"), list("HA.vs..HH", "AA.vs..AH"))
intersection = list("HA.vs..HH", "AA.vs..HH", "HPD.vs..HH", "AH.vs..HH", "AA.vs..AH", "AA.vs..HA", "APD.vs..HPD", "AA.vs..APD", "HA.vs..HPD", list("AA.vs..HH", "AH.vs..HH"), list("AH.vs..HH", "HPD.vs..HH", "AA.vs..HH", "HA.vs..HH", "APD.vs..HH"), list("HA.vs..HH", "AA.vs..AH"))

UpSet(Bool_up, set_order = c("HA.vs..HH", "AA.vs..HH", "HPD.vs..HH", "AH.vs..HH", "APD.vs..HH", "AA.vs..AH", "AA.vs..HA", "APD.vs..HPD", "AA.vs..APD", "AA.vs..HPD", "HA.vs..HPD"),
      comb_order = NULL)
```
